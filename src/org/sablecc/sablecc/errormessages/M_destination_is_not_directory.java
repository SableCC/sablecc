...
public class M_destination_is_not_directory
        extends Macro {

    // ---- constructor ----

    public M_destination_is_not_directory(
            String p_location) {
    ...
    private String get_p_location() {
        ...
        if (result == null) {
            ...
            while (!(current instanceof M_destination_is_not_directory)) {
                current = current.get_parent();
            }

            result = ((M_destination_is_not_directory) current)
