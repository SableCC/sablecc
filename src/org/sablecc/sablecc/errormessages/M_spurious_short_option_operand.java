...
public class M_spurious_short_option_operand
        extends Macro {

    // ---- constructor ----

    public M_spurious_short_option_operand(
            String p_option_name,
            String p_operand_text) {

        this.p_option_name = p_option_name;
        this.p_operand_text = p_operand_text;
    }
    ...
    private final String p_operand_text;

    String get_local_p_operand_text() {

        return this.p_operand_text;
    }
    ...
    private String get_p_option_name() {
        ...
        if (result == null) {
            ...
            while (!(current instanceof M_spurious_short_option_operand)) {
                current = current.get_parent();
            }

            result = ((M_spurious_short_option_operand) current)
    ...
    private String cached_p_operand_text;

    private String get_p_operand_text() {

        String result = this.cached_p_operand_text;
        ...
        if (result == null) {
            ...
            result = ((M_spurious_short_option_operand) current)
                    .get_local_p_operand_text();
            this.cached_p_operand_text = result;
        }
