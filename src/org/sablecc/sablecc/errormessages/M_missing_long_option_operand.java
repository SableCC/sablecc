...
public class M_missing_long_option_operand
        extends Macro {

    // ---- constructor ----

    public M_missing_long_option_operand(
    ...
    private String get_p_option_name() {
        ...
        if (result == null) {
            ...
            while (!(current instanceof M_missing_long_option_operand)) {
                current = current.get_parent();
            }

            result = ((M_missing_long_option_operand) current)
