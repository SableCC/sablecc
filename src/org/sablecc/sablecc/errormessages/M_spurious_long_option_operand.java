...
public class M_spurious_long_option_operand
        extends Macro {

    // ---- constructor ----

    public M_spurious_long_option_operand(
    ...
    private String get_p_option_name() {
        ...
        if (result == null) {
            ...
            while (!(current instanceof M_spurious_long_option_operand)) {
                current = current.get_parent();
            }

            result = ((M_spurious_long_option_operand) current)
