...
public class M_grammar_not_file
        extends Macro {

    // ---- constructor ----

    public M_grammar_not_file(
            String p_file_name) {
    ...
    private String get_p_file_name() {
        ...
        if (result == null) {
            ...
            while (!(current instanceof M_grammar_not_file)) {
                current = current.get_parent();
            }

            result = ((M_grammar_not_file) current).get_local_p_file_name();
