...
public class MCstProductionType {

    private final List<Object> eDefaultPackage_SpecifiedPackage = new LinkedList<Object>();

    private final List<Object> eCstProductionTypeDeclaration = new LinkedList<Object>();

    public MCstProductionType() {

    }

    public MCstProductionTypeDeclaration newCstProductionTypeDeclaration(
            String pName) {

        MCstProductionTypeDeclaration lCstProductionTypeDeclaration = new MCstProductionTypeDeclaration(
                pName);
        this.eCstProductionTypeDeclaration.add(lCstProductionTypeDeclaration);
        return lCstProductionTypeDeclaration;
    }
    ...
    public String toString() {
        ...
        sb.append(System.getProperty("line.separator"));
        sb.append("enum CSTProductionType {");
        sb.append(System.getProperty("line.separator"));
        for (Object oCstProductionTypeDeclaration : this.eCstProductionTypeDeclaration) {
            sb.append(oCstProductionTypeDeclaration.toString());
        }
        sb.append("}");
        sb.append(System.getProperty("line.separator"));
        return sb.toString();
