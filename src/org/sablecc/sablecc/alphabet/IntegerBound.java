...
/**
 * This class encapsulates an integer bound.
 */
public class IntegerBound
        extends GenericBound<Integer> {

    /** Constructs a integer bound with the provided value. */
    public IntegerBound(
            int value) {
    ...
    /** Returns the predecessor of this integer bound. */
    @Override
    public Bound getPredecessor() {
        ...
        return new IntegerBound(getValue() - 1);
    }
