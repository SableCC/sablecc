...
class MinimalOperation {
    ...
    private void computeGroups(
        ...
        Set<Pair<Marker, SortedSet<Acceptation>>> specificities
                = new LinkedHashSet<>();
        Map<Pair<Marker, SortedSet<Acceptation>>, SortedSet<State>> specificityMap
                = new HashMap<>();
    ...
    private void computeMinimalAlphabet(
        ...
        SortedMap<RichSymbol, Set<Pair<Group, Group>>> richSymbolToGroupPairSetMap
                = new TreeMap<>();
        ...
        Set<Pair<Set<Pair<Group, Group>>, Set<Pair<Group, Group>>>> groupPairSetPairs
                = new LinkedHashSet<>();
        Map<Pair<Set<Pair<Group, Group>>, Set<Pair<Group, Group>>>, SortedSet<Symbol>> groupPairSetPairToSymbolsMap
                = new HashMap<>();
        ...
        for (Symbol symbol : oldAutomaton.getAlphabet().getSymbols()) {
            ...
            Pair<Set<Pair<Group, Group>>, Set<Pair<Group, Group>>> groupPairSetPair
