...
class WithMarkersOperation {
    ...
    private Map<Pair<Marker, Set<Pair<State, Pair<Integer, Marker>>>>, State> stateMap
            = new HashMap<>();

    private SortedMap<State, Pair<Marker, Set<Pair<State, Pair<Integer, Marker>>>>> progressMap
            = new TreeMap<>();
