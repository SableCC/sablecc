...
import org.sablecc.objectmacro.intermediate.syntax3.parser.*;
...
public class ObjectMacroBack {
    ...
    private static void compile(
        ...
        IntermediateRepresentation ir = new IntermediateRepresentation(
                ast.getPIntermediateRepresentation(), macroFileName.substring(0, lengthFileName - ".intermediate".length()),
