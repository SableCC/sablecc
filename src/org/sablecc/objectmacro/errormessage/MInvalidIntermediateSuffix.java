...
public  class MInvalidIntermediateSuffix extends Macro{
    ...
    public MInvalidIntermediateSuffix(String pFileName, Macros macros){
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("InvalidIntermediateSuffix");
        }
        else{
        ...
        sb0.append("\", does not have a .intermediate suffix.");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
