...
public  class MUnusedTextBlock extends Macro{
    ...
    public MUnusedTextBlock(String pName, String pLine, String pChar, Macros macros){
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("UnusedTextBlock");
        }
        else{
        ...
        sb0.append("\" text block is not useful.");
