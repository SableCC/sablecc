...
public class MMissingParameter extends Macro {
    ...
    MMissingParameter(Macros macros){
        ...
        this.ParameterNameValue = new StringValue(this.list_ParameterName, this.ParameterNameContext);
    ...
    private String buildParameterName() {
        ...
        for(String string : strings) {
            ...
            if(this.ParameterNameBeforeFirst != null) {
                string = this.ParameterNameBeforeFirst.apply(i, string, nb_strings);
            }
    
            if(this.ParameterNameAfterLast != null) {
                string = this.ParameterNameAfterLast.apply(i, string, nb_strings);
            }
    
            if(this.ParameterNameSeparator != null) {
                string = this.ParameterNameSeparator.apply(i, string, nb_strings);
            }
