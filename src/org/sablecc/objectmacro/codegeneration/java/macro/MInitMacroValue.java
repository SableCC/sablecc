...
import java.util.*;
public class MInitMacroValue extends Macro {
    ...
    MInitMacroValue(String pParamName, Macros macros){
    ...
    void apply(
        ...
        internalsInitializer.setInitMacroValue(this);
    }
    ...
    public String build() {
        ...
        sb0.append("Value = new MacroValue(this.list_");
        sb0.append(buildParamName());
        sb0.append(", this.");
        sb0.append(buildParamName());
        sb0.append("Context);");
