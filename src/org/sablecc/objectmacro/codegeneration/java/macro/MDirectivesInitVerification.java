...
import java.util.*;
public class MDirectivesInitVerification extends Macro {
    
    private Map<Context, StringValue> list_ParamName = new LinkedHashMap<>();
    
    private Map<Context, StringValue> list_DirectivesName = new LinkedHashMap<>();
    
    MDirectivesInitVerification(Macros macros){
    ...
    private String buildDirectivesName(Context context) {
    ...
    private StringValue getDirectivesName(Context context) {
