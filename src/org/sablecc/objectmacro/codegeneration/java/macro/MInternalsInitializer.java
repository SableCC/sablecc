...
public class MInternalsInitializer
    ...
    private String buildParentInternalSetters() {
        ...
        for (Macro macro : macros) {
            ...
            if (this.ParentInternalSettersBeforeFirst != null) {
                expansion = this.ParentInternalSettersBeforeFirst.apply(i,
                        expansion, nb_macros);
            }

            if (this.ParentInternalSettersAfterLast != null) {
                expansion = this.ParentInternalSettersAfterLast.apply(i,
                        expansion, nb_macros);
            }

            if (this.ParentInternalSettersSeparator != null) {
                expansion = this.ParentInternalSettersSeparator.apply(i,
                        expansion, nb_macros);
            }
    ...
    private void initParentInternalSettersInternals(
            Context context) {
