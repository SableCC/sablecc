...
public class MInternalsInitializer extends Macro{
    ...
    private final Context PackageDeclarationContext = new Context();private final Context ParentInternalSetterContext = new Context();
    
    public MInternalsInitializer(){
        
        
            this.list_PackageDeclaration = new ArrayList<>();    this.list_ParentInternalSetter = new ArrayList<>();
        
            this.PackageDeclarationValue = new InternalValue(this.list_PackageDeclaration, this.PackageDeclarationContext);    this.ParentInternalSetterValue = new InternalValue(this.list_ParentInternalSetter, this.ParentInternalSetterContext);
    }
        ...
        public void addParentInternalSetter(MParentInternalsSetter macro){
            if(macro == null){
    ...
    private String buildParentInternalSetter(){
        StringBuilder sb = new StringBuilder();
        Context local_context = ParentInternalSetterContext;
        ...
        for(Macro macro : macros){
            ...
            if(this.ParentInternalSetterBeforeFirst != null){
                expansion = this.ParentInternalSetterBeforeFirst.apply(i, expansion, nb_macros);
            }
    
            if(this.ParentInternalSetterAfterLast != null){
                expansion = this.ParentInternalSetterAfterLast.apply(i, expansion, nb_macros);
            }
    
            if(this.ParentInternalSetterSeparator != null){
                expansion = this.ParentInternalSetterSeparator.apply(i, expansion, nb_macros);
            }
    ...
    private void initParentInternalSetterInternals(Context context){
    ...
    private void initParentInternalSetterDirectives(){
        ...
        this.ParentInternalSetterValue.setSeparator(this.ParentInternalSetterSeparator);
    }
    @Override
     void apply(
