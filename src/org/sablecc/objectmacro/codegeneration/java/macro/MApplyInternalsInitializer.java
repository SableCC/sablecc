...
public class MApplyInternalsInitializer
    ...
    public MApplyInternalsInitializer(
        ...
        this.ListRedefinedInternalsSetterValue = new InternalValue(
                this.list_ListRedefinedInternalsSetter,
                this.ListRedefinedInternalsSetterContext);
    }
    ...
    public void addListRedefinedInternalsSetter(
            MRedefinedInternalsSetter macro) {

        if (macro == null) {
            throw ObjectMacroException
                    .parameterNull("ListRedefinedInternalsSetter");
        }
    ...
    private String buildListRedefinedInternalsSetter() {
        ...
        Context local_context = this.ListRedefinedInternalsSetterContext;
        ...
        if (this.ListRedefinedInternalsSetterNone != null) {
            sb.append(this.ListRedefinedInternalsSetterNone.apply(i, "",
                    nb_macros));
        }
        ...
        for (Macro macro : macros) {
            ...
            if (this.ListRedefinedInternalsSetterBeforeFirst != null) {
                expansion = this.ListRedefinedInternalsSetterBeforeFirst
                        .apply(i, expansion, nb_macros);
            }

            if (this.ListRedefinedInternalsSetterAfterLast != null) {
                expansion = this.ListRedefinedInternalsSetterAfterLast.apply(i,
                        expansion, nb_macros);
            }

            if (this.ListRedefinedInternalsSetterSeparator != null) {
                expansion = this.ListRedefinedInternalsSetterSeparator.apply(i,
                        expansion, nb_macros);
            }
    ...
    private void initListRedefinedInternalsSetterInternals(
            Context context) {

        for (Macro macro : this.list_ListRedefinedInternalsSetter) {
            macro.apply(
                    new InternalsInitializer("ListRedefinedInternalsSetter") {
