...
public  class MExObjectMacroException extends Macro{
    ...
    public MExObjectMacroException(Macros macros){
    ...
    public String build(){
        ...
        if(buildState == null){
            ...
            throw ObjectMacroException.cyclicReference("ExObjectMacroException");
        }
        else{
        ...
        sb0.append(LINE_SEPARATOR);
        sb0.append("                new MUserErrorIncorrectType(type, param_name).build());");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        ...
        sb0.append("        return new ObjectMacroException(");
        sb0.append(LINE_SEPARATOR);
        sb0.append("                new MUserErrorMacroNullInList(String.valueOf(index), paramName).build());");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        ...
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        sb0.append("        return new ObjectMacroException(new MUserErrorParameterNull(paramName).build());");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        ...
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        sb0.append("        return new ObjectMacroException(new MUserErrorCyclicReference(macroName).build());");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        ...
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        sb0.append("        return new ObjectMacroException(new MUserErrorCannotModify(macroName).build());");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        ...
        sb0.append("{");
        sb0.append(LINE_SEPARATOR);
        sb0.append("        return new ObjectMacroException(new MUserErrorVersionNull().build());");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        ...
        sb0.append("{");
        sb0.append(LINE_SEPARATOR);
        sb0.append("        return new ObjectMacroException(new MUserErrorVersionsDifferent().build());");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append("}");
