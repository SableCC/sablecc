...
public class MExVersionsDifferent extends Macro {
    ...
    MExVersionsDifferent(List<Macro> pPackageDeclaration, Macros macros){
    ...
    public String build() {
        ...
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        sb0.append("        internalsInitializer.setUserErrorVersionsDifferent(this);");
        sb0.append(LINE_SEPARATOR);
        sb0.append("    }");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        ...
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
        sb0.append("        MObjectMacroUserErrorHead minsert_3 = new MObjectMacroUserErrorHead();");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
