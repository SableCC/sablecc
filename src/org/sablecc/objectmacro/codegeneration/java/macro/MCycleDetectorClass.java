...
public  class MCycleDetectorClass extends Macro{
    ...
    public MCycleDetectorClass(Macros macros){
    ...
    public void addAllPackageDeclaration(
        ...
        if(this.build_state != null){
            throw ObjectMacroException.cannotModify("CycleDetectorClass");
        }
    ...
    public String build(){
        ...
        sb0.append("{");
        sb0.append(LINE_SEPARATOR);
        sb0.append("            throw ObjectMacroException.cyclicReference(macro.getClass().getSimpleName());");
        sb0.append(LINE_SEPARATOR);
        sb0.append("        }");
        sb0.append(LINE_SEPARATOR);
        sb0.append(LINE_SEPARATOR);
