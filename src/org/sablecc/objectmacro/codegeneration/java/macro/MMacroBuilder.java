...
public class MMacroBuilder {
    ...
    private final List<Object> eContextParam = new LinkedList<>();

    private final List<Object> eContextBuildState = new LinkedList<>();
    ...
    private final List<Object> eInitInternalsCall = new LinkedList<>();
    ...
    public MInitDirectivesCall newInitDirectivesCall(
            String pParamName) {

        MInitDirectivesCall lInitDirectivesCall
                = new MInitDirectivesCall(pParamName);
    ...
    public MInitInternalsCall newInitInternalsCall(
        ...
        MInitInternalsCall lInitInternalsCall
                = new MInitInternalsCall(pParamName);
