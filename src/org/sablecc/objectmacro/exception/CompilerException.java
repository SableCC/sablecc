...
public class CompilerException
    ...
    public static CompilerException missingLongOptionOperand(
        ...
        MMissingLongOptionOperand missingLongOptionOperand = factory.newMissingLongOptionOperand();
    ...
    public static CompilerException missingShortOptionOperand(
        ...
        MMissingShortOptionOperand missingShortOptionOperand = factory.newMissingShortOptionOperand();
    ...
    public static CompilerException spuriousLongOptionOperand(
        ...
        MSpuriousLongOptionOperand spuriousLongOptionOperand = factory.newSpuriousLongOptionOperand();
    ...
    public static CompilerException invalidShortOption(
        ...
        MInvalidShortOption invalidShortOption = factory.newInvalidShortOption();
    ...
    public static CompilerException spuriousShortOptionOperand(
        ...
        MSpuriousShortOptionOperand mSpuriousShortOptionOperand = factory.newSpuriousShortOptionOperand();
    ...
    public static CompilerException invalidObjectmacroSuffix(
        ...
        MInvalidObjectmacroSuffix mInvalidObjectmacroSuffix = factory.newInvalidObjectmacroSuffix();
    ...
    public static CompilerException invalidIntermediateSuffix(
        ...
        MInvalidIntermediateSuffix mInvalidIntermediateSuffix = factory.newInvalidIntermediateSuffix();
        mInvalidIntermediateSuffix.addFileName(fileName);

        return new CompilerException(
                mInvalidIntermediateSuffix.build());
    }
    ...
    public static CompilerException inputError(
        ...
        return new CompilerException(mInputError.build(),
                cause);
    }
    ...
    public static CompilerException outputError(
        ...
        return new CompilerException(mOutputError.build(),
                cause);
    }
    ...
    public static CompilerException duplicateDeclaration(
        ...
        MDuplicateDeclaration mDuplicateDeclaration = factory.newDuplicateDeclaration();
    ...
    public static CompilerException cyclicReference(
        ...
        MParamCyclicReference mParamCyclicReference = factory.newParamCyclicReference();
    ...
    public static CompilerException incorrectArgumentType(
        ...
        MIncorrectArgumentType mIncorrectArgumentType = factory.newIncorrectArgumentType();
    ...
    public static CompilerException cannotCreateDirectory(
        ...
        MCannotCreateDirectory mCannotCreateDirectory = factory.newCannotCreateDirectory();
    ...
    public static CompilerException indentTokenMisused(
        ...
        MIndentTokenMisused mIndentTokenMisused = factory.newIndentTokenMisused();
    ...
    public static CompilerException incorrectMacroType(
        ...
        MIncorrectMacroType mIncorrectMacroType = factory.newIncorrectMacroType();
