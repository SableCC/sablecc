...
public class MDirective
    ...
    public void addAllDirectiveTextParts(
        ...
        for (Macro macro : macros) {
            ...
            verifyTypeDirectiveTextParts(macro);
    ...
    void verifyTypeDirectiveTextParts(
            Macro macro) {
    ...
    public void addDirectiveTextParts(
            MStringPart macro) {
    ...
    private String buildDirectiveName() {
        ...
        for (Macro macro : macros) {
            ...
            if (this.DirectiveNameBeforeFirst != null) {
                expansion = this.DirectiveNameBeforeFirst.apply(i, expansion,
                        nb_macros);
            }

            if (this.DirectiveNameAfterLast != null) {
                expansion = this.DirectiveNameAfterLast.apply(i, expansion,
                        nb_macros);
            }

            if (this.DirectiveNameSeparator != null) {
                expansion = this.DirectiveNameSeparator.apply(i, expansion,
                        nb_macros);
            }
    ...
    private String buildDirectiveTextParts() {
        ...
        for (Macro macro : macros) {
            ...
            if (this.DirectiveTextPartsBeforeFirst != null) {
                expansion = this.DirectiveTextPartsBeforeFirst.apply(i,
                        expansion, nb_macros);
            }

            if (this.DirectiveTextPartsAfterLast != null) {
                expansion = this.DirectiveTextPartsAfterLast.apply(i, expansion,
                        nb_macros);
            }

            if (this.DirectiveTextPartsSeparator != null) {
                expansion = this.DirectiveTextPartsSeparator.apply(i, expansion,
                        nb_macros);
            }
    ...
    private void initDirectiveNameInternals(
            Context context) {
    ...
    private void initDirectiveTextPartsInternals(
            Context context) {
