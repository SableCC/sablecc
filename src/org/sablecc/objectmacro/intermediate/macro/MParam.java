...
public class MParam
    ...
    private String buildParamName() {
        ...
        Context local_context = this.ParamNameContext;
        ...
        for (Macro macro : macros) {
            ...
            if (this.ParamNameBeforeFirst != null) {
                expansion = this.ParamNameBeforeFirst.apply(i, expansion,
                        nb_macros);
            }

            if (this.ParamNameAfterLast != null) {
                expansion = this.ParamNameAfterLast.apply(i, expansion,
                        nb_macros);
            }

            if (this.ParamNameSeparator != null) {
                expansion = this.ParamNameSeparator.apply(i, expansion,
                        nb_macros);
            }
    ...
    private void initParamNameInternals(
            Context context) {
