...
public class MInternal
    ...
    MInternal(
        ...
        this.InternalNameValue = new MacroValue(this.list_InternalName,
    ...
    private String buildInternalName() {
        ...
        for (Macro macro : macros) {
            ...
            if (this.InternalNameBeforeFirst != null) {
                expansion = this.InternalNameBeforeFirst.apply(i, expansion,
                        nb_macros);
            }

            if (this.InternalNameAfterLast != null) {
                expansion = this.InternalNameAfterLast.apply(i, expansion,
                        nb_macros);
            }

            if (this.InternalNameSeparator != null) {
                expansion = this.InternalNameSeparator.apply(i, expansion,
                        nb_macros);
            }
    ...
    private String buildDirectives() {
        ...
        for (Macro macro : macros) {
            ...
            if (this.DirectivesBeforeFirst != null) {
                expansion = this.DirectivesBeforeFirst.apply(i, expansion,
                        nb_macros);
            }

            if (this.DirectivesAfterLast != null) {
                expansion = this.DirectivesAfterLast.apply(i, expansion,
                        nb_macros);
            }

            if (this.DirectivesSeparator != null) {
                expansion = this.DirectivesSeparator.apply(i, expansion,
                        nb_macros);
            }
    ...
    private void initInternalNameInternals(
            Context context) {
    ...
    private void initTypeInternals(
            Context context) {
    ...
    private void initDirectivesInternals(
            Context context) {
