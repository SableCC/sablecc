...
public class MMacroType
    ...
    private String buildReferences() {
        ...
        for (Macro macro : macros) {
            ...
            if (this.ReferencesBeforeFirst != null) {
                expansion = this.ReferencesBeforeFirst.apply(i, expansion,
                        nb_macros);
            }

            if (this.ReferencesAfterLast != null) {
                expansion = this.ReferencesAfterLast.apply(i, expansion,
                        nb_macros);
            }

            if (this.ReferencesSeparator != null) {
                expansion = this.ReferencesSeparator.apply(i, expansion,
                        nb_macros);
            }
    ...
    private void initReferencesInternals(
            Context context) {
