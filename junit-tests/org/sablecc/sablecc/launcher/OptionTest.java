...
public class OptionTest {
    ...
    Option checkOnly = Option.NO_CODE;

    Option destination = Option.DESTINATION;

    @Test
    public void testHasOperand() {

        assertFalse("this option has no operand", this.checkOnly.hasOperand());
        assertTrue("this option has an operand", this.destination.hasOperand());
    }
