...
public class StateTest {
    ...
    public void testGetForwardTransitions() {
        ...
        // Case with non-stable State
        try {
            this.firstState.getForwardTransitions();
    ...
    @Test
    public void testGetBackwardTransitions() {

        // Case with non-stable State
        try {
            this.firstState.getBackwardTransitions();
            fail("the state is not stable yet");
        }
        catch (InternalException e) {
            // Expected
    ...
    public void testAddForwardTransition() {
        ...
        assertTrue(
                "the forward transition should contain at least transition.",
                this.firstState.getForwardTransitions().contains(
                        this.transition));
    ...
    public void testAddBackwardTransition() {
        ...
        this.secondState.stabilize();
        assertTrue(
                "the forward transition should contain at least transition.",
                this.secondState.getBackwardTransitions().contains(
                        this.transition));
    ...
    public void testRemoveForwardTransition() {
        ...
        this.firstState.stabilize();
        assertFalse("The transition should have been removed", this.firstState
                .getForwardTransitions().contains(this.transition));
    ...
    public void testRemoveBackwardTransition() {
        ...
        this.secondState.stabilize();
        assertFalse("The transition should have been removed", this.secondState
                .getBackwardTransitions().contains(this.transition));
    ...
    public void testStabilize() {
        ...
        // Case with already stabilized State
        this.firstState.stabilize();

        try {
            this.firstState.stabilize();
            fail("state is already stable");
        }
        catch (InternalException e) {
            // Expected
        }
