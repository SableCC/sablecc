...
public class MF extends Macro{
    ...
    private final Context XContext = new Context();    private final Context YContext = new Context();

    public MF(){


    this.list_X = new ArrayList<>();    this.list_Y = new ArrayList<>();

    this.XValue = new InternalValue(this.list_X, this.XContext);    this.YValue = new InternalValue(this.list_Y, this.YContext);
    }
    ...
    public void addX(MG macro){
        if(macro == null){
            ...
            throw ObjectMacroException.cannotModify("G");
        }
    ...
    public void addY(MH macro){
        if(macro == null){
            throw ObjectMacroException.parameterNull("Y");
                ...
                if(this.build_state != null){
            throw ObjectMacroException.cannotModify("H");
        }
